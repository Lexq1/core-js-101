 ...
 *   0    => 0
 */
const getCircleCircumference = (r) => 2 * r * Math.PI;
 ...
 *     0     => 0
 */
const getLastDigit = (n) => +String(n).at(-1);
 ...
 * '-525.5'     => -525.5
 */
const parseNumberFromString = (n) => +n;
 ...
 */
const getParallelepipedDiagonal = (a, b, c) => (a ** 2 + b ** 2 + c ** 2) ** 0.5;
 ...
 */
const toNumber = (n, def) => (Number(n) ? Number(n) : def);
